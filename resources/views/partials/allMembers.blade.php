<div class="flex justify-center gap-5 flex-wrap">
    @foreach ($users as $user )
        ...
        <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 text-blue-500">
            ...
            <div class="py-5 text-center">
                <a href="#" class="block text-2xl font-bold text-blue-800 dark:text-blue"> {{$user->nom}} </a>
                <span class="text-sm text-blue-700 dark:text-blue-200">{{$user->age}}</span>
                <span class="text-sm text-blue-700 dark:text-blue-200">{{$user->genre}}</span>
            </div>
        </div>
        @endif
    @endforeach
